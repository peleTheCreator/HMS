    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserContactId = table.Column<string>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "ProductPurchaseOrderTracking",
                columns: table => new
                {
                    ProductPurchaseOrderTrackerId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    ProductId = table.Column<string>(nullable: true),
                    TotalPoductQty = table.Column<int>(nullable: false),
                    RemainingProductQty = table.Column<int>(nullable: false),
                    DateTime = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductPurchaseOrderTracking", x => x.ProductPurchaseOrderTrackerId);
                    table.ForeignKey(
                        name: "FK_ProductPurchaseOrderTracking_Products_ProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CostOfOne = table.Column<decimal>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SalesOrderId = table.Column<string>(nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductPurchaseOrderTracking_ProductId",
