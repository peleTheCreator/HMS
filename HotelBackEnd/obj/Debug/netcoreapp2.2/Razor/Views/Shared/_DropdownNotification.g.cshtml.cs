#pragma checksum "C:\Users\23490\Documents\HMS\HotelManagementSystem\HotelBackEnd\Views\Shared\_DropdownNotification.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "d4715c73eb4c99ed2df5891cbf3a91bccbaa5e3a"
// <auto-generated/>
...
[assembly:global::Microsoft.AspNetCore.Mvc.Razor.Compilation.RazorViewAttribute(@"/Views/Shared/_DropdownNotification.cshtml", typeof(AspNetCore.Views_Shared__DropdownNotification))]
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"d4715c73eb4c99ed2df5891cbf3a91bccbaa5e3a", @"/Views/Shared/_DropdownNotification.cshtml")]
...
<div class=""tab-content tab-notification"">
    <div class=""tab-pane active p-3 text-center"">
        <h5 class=""mt-4 pt-4 fw-500"">
            <span class=""d-block fa-3x pb-4 tex");
            WriteLiteral(@"t-faded"">
                ...
                <li class=""unread"">
                    <a href=""#"" class=""d-flex align-items-center"">
                        ...
                        <span class=""d-flex flex-column flex-1 ml-1"">
                            <span class=""na");
            WriteLiteral(@"me"">Melissa Ayre <span class=""badge badge-primary fw-n position-absolute pos-top pos-right mt-1"">INBOX</span></span>
                ...
                <li class=""unread"">
                    <a href=""#"" class=""d-flex align-items-center"">
                        ...
                        <span class=""d-flex flex-column flex-1 ml-1"">
                            ...
                            <span class=""msg-a fs-sm"">Msed quia");
            WriteLiteral(@" non numquam eius</span>
                ...
                <li>
                    <a href=""#"" class=""d-flex align-items-cente");
            WriteLiteral(@"r"">
                ...
                <li>
                    ...
                    ");
            WriteLiteral(@"        <span class=""profile-image rounded-circle d-inline-block"" style=""background-image:url('img/demo/avatars/avatar-h.png')""></span>
                        </span>
                        <span class=""d-flex flex-column flex-1 ml-1"">
                ...
                <li>
                    <a href=""#"" class=""d-flex align-items-center"">
                        ...
                        <span class=""d-flex flex-column flex-1 ml-1"">
                            <span class");
            WriteLiteral(@"=""name"">Anothony Bezyeth</span>
                            <span class=""msg-a fs-sm"">Msed quia non numquam eius</span>
                ...
                <li class=""unread"">
                    <div class=""d-flex align-items-center show-child-on-hover"">
                        ...
                        <div class=""show-on-hover-parent position-absolute pos-right pos-bottom p-3"">
                            <a href=""");
            WriteLiteral(@"#"" class=""text-muted"" title=""delete""><i class=""fal fa-trash-alt""></i></a>
                        </div>
                    </div>
                </li>
                <li>
                    <div class=""d-flex align-items-center show-child-on-hover"">
                        ...
                        <div class=""show-on-hover-parent position-absolute pos-right pos-bottom p-3"">
                            <a href=""#"" class=""text-muted"" title=""del");
            WriteLiteral(@"ete""><i class=""fal fa-trash-alt""></i></a>
                        </div>
                    </div>
                </li>
                <li>
                    <div class=""d-flex align-items-center show-child-on-hover"">
                        <div class=""d-flex flex-column flex-1"">
                            ...
                            <div class=""fs-sm d-flex align-items-center mt-2"">
                                ...
                                <span class=""profile-image-md mr-1 rounded-circle d");
            WriteLiteral(@"-inline-block"" style=""background-image:url('/img/demo/avatars/avatar-c.png'); background-size: cover;""></span>
            ...
            WriteLiteral(@"                    </div>
                ...
                <li>
                    <div class=""d-flex align-items-center show-child-on-hover"">
                        ...
                        <div class=""show-on-hover-parent position-absolute pos-right pos-bottom p-3"">
                            <a hre");
            WriteLiteral(@"f=""#"" class=""text-muted"" title=""delete""><i class=""fal fa-trash-alt""></i></a>
                        </div>
                    </div>
                </li>
                <li>
                        ...
                        <div class=""d-flex flex-column flex-1"">
                            ...
                            <div class=""fs-sm d-flex align-items-center mt-1"">
                                ...
                                <a href=""#"" class=""mr-1 mt-1"" title=""Patient A-473 saliva"">
                                    <span class=""d-block img-share"" style=""background-image:url('img/thumbs/pic-8.png'); background-size:");
            ...
            WriteLiteral(@"             </div>
                ...
                <li>
                    <div class=""d-flex align-items-center show-child-on-hover"">
                       ...
                       ");
            WriteLiteral(@"     <div class=""progress progress-sm d-flex mt-1"">
        ...
        <div class=""d-flex flex-column h-100"">
            <div class=""h-auto"">
                <table class=""table table-bordered table-calendar m-0 w-100 h-100 border-0"">
                    <tr>
 ");
            WriteLiteral(@"                       <th colspan=""7"" class=""pt-3 pb-2 pl-3 pr-3 text-center"">
            ...
            <div class=""flex-1 custom-scroll"">
                <div class=""p-2"">
                    ...
                    <div class=""d-flex align-items-center text-left"">
                        <div class=""width-5 fw-300 text-primary l-h-n mr-1"" style=""font-size: 32px;"">
                            15
                        </div>
                        <div class=""flex-1"">
                            <div class=""d-flex flex-column"">
                                ...
                                <span class=""l-h-n fs-nano fw-400 text-se");
